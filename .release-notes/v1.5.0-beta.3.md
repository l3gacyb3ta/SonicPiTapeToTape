...
```bash
npm install @mjayb/sonicweb        # latest tag now points here
npm install @mjayb/sonicweb@beta   # beta tag — same version
```

Browser: <https://sonicweb.cc>

See [KNOWN_ISSUES.md](https://github.com/MrityunjayBhardwaj/SonicWeb/blob/main/KNOWN_ISSUES.md)
